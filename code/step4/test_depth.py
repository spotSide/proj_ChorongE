...
async def unified_depth(shared_data):
    """비동기적으로 뎁스 모델을 실행하고 섹션 분석과 시각화를 수행합니다."""
    ...
    while shared_data['running']:
        ...
        try:
            ...
            # 화면 출력 (크기 조정 포함)
            depth_frame_resized = cv2.resize(depth_frame_with_sections, (1280, 720))
            cv2.imshow("Depth Estimation", depth_frame_resized)
